...
btn_cam=tk.Button(window, text="Start Camera",width=50,command=start_camera_stream)
btn_cam.pack(anchor=tk.CENTER,expand=True)

btn_mic=tk.Button(window, text="Start Mic",width=50,command=start_audio_stream)
btn_mic.pack(anchor=tk.CENTER,expand=True)
